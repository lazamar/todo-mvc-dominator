 ...
 */  
  ...
  var viewEntry = function (todo) {
      return Dominator_Html.li([ Dominator_Html_Attributes.classList([ new Data_Tuple.Tuple("completed", todo.completed), new Data_Tuple.Tuple("editing", todo.editing) ]) ])([ Dominator_Html.div([ Dominator_Html_Attributes.class_("view") ])([ Dominator_Html.input([ Dominator_Html_Attributes.class_("toggle"), Dominator_Html_Attributes.type_("checkbox"), Dominator_Html_Attributes.checked(todo.completed), Dominator_Html_Events.onClick(new Check(todo.id, !todo.completed)) ])([  ]), Dominator_Html.label([ Dominator_Html_Events.onDoubleClick(new EditingEntry(todo.id, true)) ])([ Dominator_Html.text(todo.description) ]), Dominator_Html.button([ Dominator_Html_Attributes.class_("destroy"), Dominator_Html_Events.onClick(new Delete(todo.id)) ])([  ]) ]), Dominator_Html.input([ Dominator_Html_Attributes.class_("edit"), Dominator_Html_Attributes.value(todo.description), Dominator_Html_Attributes.name("title"), Dominator_Html_Attributes.id("todo-" + Data_Show.show(Data_Show.showInt)(todo.id)), Dominator_Html_Events.onInput(UpdateEntry.create(todo.id)), Dominator_Html_Events.onBlur(new EditingEntry(todo.id, false)), onEnter(new EditingEntry(todo.id, false)) ])([  ]) ]);
  };

  // VIEW INDIVIDUAL ENTRIES
  var viewKeyedEntry = function (todo) {
      return new Data_Tuple.Tuple(Data_Show.show(Data_Show.showInt)(todo.id), Dominator_Html_Lazy.lazy(viewEntry)(todo));
  };
  ...
  var update = function (msg) {
      return function (model) {
          ...
          throw new Error("Failed pattern match at Todo line 135, column 5 - line 208, column 51: " + [ msg.constructor.name ]);
      };
  };
