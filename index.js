 ...
 */  
  ...
  var update = function (msg) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Todo line 170, column 5 - line 243, column 57: " + [ msg.constructor.name ]);
      };
  };
  ...
  var encodeModel = function (model) {
      return Data_Foreign_Generic.genericEncode(genericModel)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
          return "Model";
      }))(Data_Foreign_Generic_Class.genericEncodeArgsRec(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "entries";
 ...
 */  
  var updateWithStorage = function (msg) {
      return function (model) {
          ...
          return new Data_Tuple.Tuple(v.value0, Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value1)([ Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))($foreign.setStorage(encodeModel(v.value0))) ]));
      };
  };
  var emptyModel = {
  ...
  var init = function (maybeModel) {
      ...
      throw new Error("Failed pattern match at Todo line 140, column 5 - line 142, column 33: " + [ maybeModel.constructor.name ]);
  };
  ...
  var decodeModel = function (v) {
      var parsed = Control_Monad_Except.runExcept(Data_Foreign_Generic.genericDecode(genericModel)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
          return "Model";
      }))(Data_Foreign_Generic_Class.genericDecodeArgsRec(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "entries";
      ...
      throw new Error("Failed pattern match at Todo line 133, column 9 - line 135, column 30: " + [ parsed.constructor.name ]);
  };
