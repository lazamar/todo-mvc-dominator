...
(function(exports) {
  ...
  var EmbedWithin = (function () {
      function EmbedWithin(value0) {
          this.value0 = value0;
      };
      EmbedWithin.create = function (value0) {
          return new EmbedWithin(value0);
      };
      return EmbedWithin;
  })();
  ...
  var program = function (container) {
      return function (v) {
          var maybeContainer = (function () {
              if (container instanceof FullScreen) {
                  return Data_Maybe.Nothing.value;
              };
              if (container instanceof EmbedWithin) {
                  return new Data_Maybe.Just(container.value0);
              };
              throw new Error("Failed pattern match at Dominator.Html line 203, column 22 - line 205, column 32: " + [ container.constructor.name ]);
          })();
          return Dominator_Native_Platform.program(maybeContainer)(Dominator_Native_Scheduler.scheduler)(Dominator_Native_VirtualDom.normalRenderer)(v.init)(v.update)(v.view);
      };
  };
  ...
  exports["EmbedWithin"] = EmbedWithin;
  exports["text"] = text;
  exports["node"] = node;
 ...
 */  
  var opts = (function () {
      ...
      for (var $37 in Data_Foreign_Generic.defaultOptions) {
          if ({}.hasOwnProperty.call(Data_Foreign_Generic.defaultOptions, $37)) {
              $36[$37] = Data_Foreign_Generic["defaultOptions"][$37];
          };
      };
      $36.unwrapSingleConstructors = true;
      return $36;
  })();
  ...
  var viewControls = function (visibility) {
      return function (entries) {
          var entriesCompleted = Data_Array.length(Data_Array.filter(isCompleted)(entries));
          var entriesLeft = Data_Array.length(entries) - entriesCompleted | 0;
          return Dominator_Html.footer([ Dominator_Html_Attributes.class_("footer"), Dominator_Html_Attributes.hidden(Data_Array["null"](entries)) ])([ Dominator_Html_Lazy.lazy(viewControlsCount)(entriesLeft), Dominator_Html_Lazy.lazy(viewControlsFilters)(visibility), Dominator_Html_Lazy.lazy(viewControlsClear)(entriesCompleted) ]);
      };
  };
  ...
  var genericModel = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.entries, new Data_Generic_Rep.Product(x.field, new Data_Generic_Rep.Product(x.uid, x.visibility)));
  }, function (x) {
      return {
          entries: x.value0,
          field: x.value1.value0,
          uid: x.value1.value1.value0,
          visibility: x.value1.value1.value1
      };
  });
  var genericEntry = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.completed, new Data_Generic_Rep.Product(x.description, new Data_Generic_Rep.Product(x.editing, x.id)));
  }, function (x) {
      return {
          completed: x.value0,
          description: x.value1.value0,
          editing: x.value1.value1.value0,
          id: x.value1.value1.value1
      };
  });
      ...
      return function (v) {
          ...
          if (msg instanceof Add) {
              return new Data_Tuple.Tuple((function () {
                  ...
                  $71.field = "";
                  $71.entries = (function () {
                      var $70 = Data_String["null"](v.field);
                      if ($70) {
                          return v.entries;
                      };
                      return Data_Array.cons(newEntry(v.field)(v.uid))(v.entries);
                  })();
                  return $71;
              })(), [  ]);
          };
          ...
          if (msg instanceof EditingEntry) {
              ...
              return new Data_Tuple.Tuple((function () {
                  ...
                  $83.entries = Data_Functor.map(Data_Functor.functorArray)(updateEntry)(v.entries);
                  return $83;
          ...
          if (msg instanceof UpdateEntry) {
              ...
              return new Data_Tuple.Tuple((function () {
                  ...
                  $93.entries = Data_Functor.map(Data_Functor.functorArray)(updateEntry)(v.entries);
                  return $93;
              })(), [  ]);
          };
          if (msg instanceof Delete) {
              return new Data_Tuple.Tuple((function () {
                  ...
                  $98.entries = Data_Array.filter(function (t) {
          ...
          if (msg instanceof DeleteComplete) {
              return new Data_Tuple.Tuple((function () {
                  ...
                  $102.entries = Data_Array.filter(function ($139) {
                      return !isCompleted($139);
                  })(v.entries);
                  return $102;
              })(), [  ]);
          };
          if (msg instanceof Check) {
              ...
              return new Data_Tuple.Tuple((function () {
                  ...
                  $110.entries = Data_Functor.map(Data_Functor.functorArray)(updateEntry)(v.entries);
                  return $110;
              })(), [  ]);
          };
          if (msg instanceof CheckAll) {
              ...
              return new Data_Tuple.Tuple((function () {
                  ...
                  $119.entries = Data_Functor.map(Data_Functor.functorArray)(updateEntry)(v.entries);
                  return $119;
              })(), [  ]);
          };
          if (msg instanceof ChangeVisibility) {
              return new Data_Tuple.Tuple((function () {
                  ...
                  $123.visibility = msg.value0;
                  return $123;
              })(), [  ]);
          };
          throw new Error("Failed pattern match at Todo line 201, column 5 - line 274, column 57: " + [ msg.constructor.name ]);
      };
  };
  ...
  var encodeEntry = new Data_Foreign_Class.Encode(Data_Foreign_Generic.genericEncode(genericEntry)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Entry";
      ...
      return "editing";
  }))(Data_Foreign_Class.booleanEncode))(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
      return "id";
  }))(Data_Foreign_Class.intEncode)))))))(opts));
  var encodeFlags = function (model) {
      return Data_Foreign_Generic.genericEncodeJSON(genericModel)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
          return "Model";
      }))(Data_Foreign_Generic_Class.genericEncodeArgsRec(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "entries";
      }))(Data_Foreign_Class.arrayEncode(encodeEntry)))(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "field";
      }))(Data_Foreign_Class.stringEncode))(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "uid";
      }))(Data_Foreign_Class.intEncode))(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "visibility";
      }))(Data_Foreign_Class.stringEncode)))))))(opts)(model);
  };
 ...
 */  
  var updateWithStorage = function (msg) {
      return function (model) {
          ...
          return new Data_Tuple.Tuple(v.value0, Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value1)([ Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))($foreign.setStorage(encodeFlags(v.value0))) ]));
      };
  };
  var encodeModel = new Data_Foreign_Class.Encode(Data_Foreign_Generic.genericEncode(genericModel)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Model";
  }))(Data_Foreign_Generic_Class.genericEncodeArgsRec(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
      return "entries";
  }))(Data_Foreign_Class.arrayEncode(encodeEntry)))(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
      ...
      return "visibility";
  }))(Data_Foreign_Class.stringEncode)))))))(opts));
  var emptyModel = {
      entries: [  ],
      visibility: "All",
      field: "",
  ...
  var init = function (maybeModel) {
      ...
      throw new Error("Failed pattern match at Todo line 170, column 5 - line 172, column 33: " + [ maybeModel.constructor.name ]);
  };
  var decodeEntry = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericEntry)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Entry";
      ...
      return "id";
  }))(Data_Foreign_Class.intDecode))))))(Data_Foreign_Generic_Class.genericCountArgsRec))(opts));
  var decodeFlags = function (v) {
      var parsed = Control_Monad_Except.runExcept(Data_Foreign_Generic.genericDecodeJSON(genericModel)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
          return "Model";
      }))(Data_Foreign_Generic_Class.genericDecodeArgsRec(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "entries";
      }))(Data_Foreign_Class.arrayDecode(decodeEntry)))(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "field";
      }))(Data_Foreign_Class.stringDecode))(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "uid";
      }))(Data_Foreign_Class.intDecode))(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
          return "visibility";
      }))(Data_Foreign_Class.stringDecode))))))(Data_Foreign_Generic_Class.genericCountArgsRec))(opts)(v));
      if (parsed instanceof Data_Either.Right) {
          return new Data_Maybe.Just(parsed.value0);
      };
      if (parsed instanceof Data_Either.Left) {
          return Data_Maybe.Nothing.value;
      };
      throw new Error("Failed pattern match at Todo line 163, column 9 - line 165, column 30: " + [ parsed.constructor.name ]);
  };
 ...
 */  
  var embed = function (el) {
      return function (flags) {
          return Dominator_Html.program(new Dominator_Html.EmbedWithin(el))({
  ...
  var decodeModel = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericModel)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Model";
  }))(Data_Foreign_Generic_Class.genericDecodeArgsRec(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
      return "entries";
  }))(Data_Foreign_Class.arrayDecode(decodeEntry)))(Data_Foreign_Generic_Class.genericDecodeFieldsProduct(Data_Foreign_Generic_Class.genericDecodeFieldsField(new Data_Symbol.IsSymbol(function () {
      ...
      return "visibility";
  }))(Data_Foreign_Class.stringDecode))))))(Data_Foreign_Generic_Class.genericCountArgsRec))(opts));
  exports["embed"] = embed;
  ...
  exports["encodeEntry"] = encodeEntry;
