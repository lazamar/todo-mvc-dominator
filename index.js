 ...
 */  
  ...
  var parseFlags = function (v) {
      ...
      throw new Error("Failed pattern match at Todo line 121, column 9 - line 123, column 30: " + [ parsed.constructor.name ]);
  };
      ...
      return function (model) {
          ...
          if (msg instanceof Add) {
              return new Data_Tuple.Tuple((function () {
                  var $47 = {};
                  for (var $48 in model) {
                      if ({}.hasOwnProperty.call(model, $48)) {
                          $47[$48] = model[$48];
                      };
                  };
                  $47.uid = model.uid + 1 | 0;
                  $47.field = "";
                  $47.entries = (function () {
                      var $46 = Data_String["null"](model.field);
                      if ($46) {
          ...
          if (msg instanceof UpdateField) {
              return new Data_Tuple.Tuple((function () {
                  var $50 = {};
                  for (var $51 in model) {
                      if ({}.hasOwnProperty.call(model, $51)) {
                          $50[$51] = model[$51];
                      };
                  };
                  $50.field = msg.value0;
          ...
          if (msg instanceof EditingEntry) {
              var updateEntry = function (v) {
                  return Entry((function () {
                      var $55 = v.id === msg.value0;
                      if ($55) {
                          var $56 = {};
                          for (var $57 in v) {
              ...
              return new Data_Tuple.Tuple((function () {
                  var $59 = {};
                  for (var $60 in model) {
                      if ({}.hasOwnProperty.call(model, $60)) {
                          $59[$60] = model[$60];
                      };
                  };
                  $59.entries = Data_Functor.map(Data_List_Types.functorList)(updateEntry)(model.entries);
                  return $59;
          ...
          if (msg instanceof UpdateEntry) {
              ...
              return new Data_Tuple.Tuple((function () {
                  var $69 = {};
                  for (var $70 in model) {
                      if ({}.hasOwnProperty.call(model, $70)) {
                          $69[$70] = model[$70];
                      };
                  };
                  $69.entries = Data_Functor.map(Data_List_Types.functorList)(updateEntry)(model.entries);
                  return $69;
              })(), [  ]);
          };
          if (msg instanceof Delete) {
              return new Data_Tuple.Tuple((function () {
                  var $74 = {};
                  for (var $75 in model) {
                      if ({}.hasOwnProperty.call(model, $75)) {
                          $74[$75] = model[$75];
                      };
                  };
                  $74.entries = Data_List.filter(function (t) {
          ...
          if (msg instanceof DeleteComplete) {
              return new Data_Tuple.Tuple((function () {
                  var $78 = {};
                  for (var $79 in model) {
                      if ({}.hasOwnProperty.call(model, $79)) {
                          $78[$79] = model[$79];
                      };
                  };
                  $78.entries = Data_List.filter(function ($111) {
                      return !isCompleted($111);
                  })(model.entries);
                  return $78;
              })(), [  ]);
          };
          if (msg instanceof Check) {
              ...
              return new Data_Tuple.Tuple((function () {
                  ...
                  $86.entries = Data_Functor.map(Data_List_Types.functorList)(updateEntry)(model.entries);
                  return $86;
              })(), [  ]);
          };
          if (msg instanceof CheckAll) {
              ...
              return new Data_Tuple.Tuple((function () {
                  var $95 = {};
                  for (var $96 in model) {
                      if ({}.hasOwnProperty.call(model, $96)) {
                          $95[$96] = model[$96];
                      };
                  };
                  $95.entries = Data_Functor.map(Data_List_Types.functorList)(updateEntry)(model.entries);
                  return $95;
              })(), [  ]);
          };
          if (msg instanceof ChangeVisibility) {
              return new Data_Tuple.Tuple((function () {
                  var $99 = {};
                  for (var $100 in model) {
                      if ({}.hasOwnProperty.call(model, $100)) {
                          $99[$100] = model[$100];
                      };
                  };
                  $99.visibility = msg.value0;
                  return $99;
              })(), [  ]);
          };
          throw new Error("Failed pattern match at Todo line 158, column 5 - line 231, column 51: " + [ msg.constructor.name ]);
      };
  };
 ...
 */  
  ...
  var viewEntries = function (visibility) {
      return function (entries) {
          ...
          var cssVisibility = (function () {
              var $108 = Data_List["null"](entries);
              if ($108) {
                  return "hidden";
              };
              return "visible";
  ...
  var init = function (maybeModel) {
      ...
      throw new Error("Failed pattern match at Todo line 128, column 5 - line 130, column 33: " + [ maybeModel.constructor.name ]);
  };
